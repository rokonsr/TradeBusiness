    ...
    public class CompanyInfoBLL
    {
            ...
            foreach (DataRow dr in objDataTable.Rows)
            {
                ...
                switch (column)
                {
                    ...
                    case "AdminUserId":
                        ...
                        {
                            objCompanyInfo.AdminUserId = Convert.ToInt16(objDataReader["AdminUserId"]);
                        }
                        break;
                    case "AdminUsername":
        ...
        public CompanyInfo GetCompanyInfo(int companyId)
        {
            ...
            try
            {
                ...
                objDbDataReader = objDataAccess.ExecuteReader(objDbCommand, "[dbo].[uspGetCompanyInfo]", CommandType.StoredProcedure);
        ...
        public string UpdateCompanyInfo(CompanyInfo objCompanyInfo)
        {
            int noRowCount = 0;
            ...
            try
            {
                noRowCount = objDataAccess.ExecuteNonQuery(objDbCommand, "[dbo].uspUpdateCompanyInfo", CommandType.StoredProcedure);
        ...
        public string DeleteCompanyInfo(int companyId)
        {
            int noRowCount = 0;
            ...
            try
            {
                noRowCount = objDataAccess.ExecuteNonQuery(objDbCommand, "[dbo].uspDeleteCompanyInfo", CommandType.StoredProcedure);
